    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (isReplicaSetCache === null || now - replicaSetCheckTime > REPLICA_SET_CHECK_INTERVAL) {
            ...
            if (!db) {
                ...
                logger_service_1.logger.warn(`⚠️  MongoDB baglantisi henuz hazir degil - transactions will be disabled`);
            }
            else {
                try {
                    const admin = db.admin();
                    yield admin.replSetGetStatus();
        ...
        try {
            ...
            if (options.onError && session) {
                try {
                    yield options.onError(error, session);
                }
                catch (handlerError) {
...
exports.TransactionControl = {
    ...
    commit(req) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.dbSession && req.dbSession.inTransaction()) {
                yield req.dbSession.commitTransaction();
    ...
    rollback(req) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.dbSession && req.dbSession.inTransaction()) {
                yield req.dbSession.abortTransaction();
