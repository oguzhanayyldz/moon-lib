...
class BaseModernEntityDeletedListener extends __1.RetryableListener {
     ...
     */
    async processEntityDeletion(entity, userId, parentSpan) {
        var _a, _b, _c;
        ...
        try {
            ...
            if (strategy) {
                ...
                const result = await entityDeletionRegistry_1.entityDeletionRegistry.execute({
                    entityType: entity.entity,
                    entityId: entity.entityId,
                    userId,
                    serviceName: this.serviceName,
     ...
     */
    async validateAndSanitizeInput(data, span) {
        var _a;
     ...
     */
    async performAuthorizationChecks(data, userId, span) {
        var _a;
     ...
     */
    async performServiceSpecificAuthorization(data, userId, span) {
...
//# sourceMappingURL=BaseModernEntityDeletedListener.js.map