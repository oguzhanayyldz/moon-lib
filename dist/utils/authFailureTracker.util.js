...
class AuthFailureTracker {
     ...
     */
    static increment(context, lastErrorStatus, lastErrorMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (count >= threshold) {
                yield AuthFailureTracker.publishExceededEvent(context, count, lastErrorStatus, lastErrorMessage);
            }
            return count;
        });
    }
     ...
     */
    static reset(userId, integrationId) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    static get(userId, integrationId) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = AuthFailureTracker.getKey(userId, integrationId);
            try {
     ...
     */
    static publishExceededEvent(context, failureCount, lastErrorStatus, lastErrorMessage) {
        return __awaiter(this, void 0, void 0, function* () {
