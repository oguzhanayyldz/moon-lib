...
class MicroserviceSecurityService {
        ...
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.rateLimiter && typeof this.rateLimiter.checkAPIKeyRateLimit === 'function') {
                    ...
                    const result = yield this.rateLimiter.checkAPIKeyRateLimit(apiKey, endpoint);
                    if (!result.allowed) {
    ...
    generateCSRFToken(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const userId = (_a = req.currentUser) === null || _a === void 0 ? void 0 : _a.id;
            return yield this.csrfService.generateToken(req, this.config.serviceName, userId);
        });
    }
    /**
