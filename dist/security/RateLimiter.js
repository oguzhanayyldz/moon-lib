...
class RateLimiter {
    ...
    checkIPRateLimit(ip, endpoint) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const current = yield this.redisClient.incr(windowKey);
                yield this.redisClient.expire(windowKey, Math.ceil(this.config.windowMs / 1000));
     ...
     */
    checkUserRateLimit(userId, endpoint) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    checkAPIKeyRateLimit(apiKey, endpoint) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    middleware(options) {
        ...
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.checkIPRateLimit(key, endpoint);
    ...
    userMiddleware(options) {
        ...
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.checkUserRateLimit(userId, endpoint);
                // Set rate limit headers
                res.set({
                    'X-RateLimit-Limit': config.maxRequests.toString(),
                    'X-RateLimit-Remaining': Math.max(0, config.maxRequests - result.totalHits).toString(),
     ...
     */
    getRateLimitStatus(key, endpoint) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const now = Date.now();
                const windowStart = Math.floor(now / this.config.windowMs) * this.config.windowMs;
                const windowKey = `rate_limit:ip:${key}:${endpoint}:${windowStart}`;
                const current = yield this.redisClient.get(windowKey);
