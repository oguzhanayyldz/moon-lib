...
class SecurityMonitor {
     ...
     */
    sendExternalAlert(event, eventCount, message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Slack webhook integration
                const slackWebhookUrl = process.env.SECURITY_SLACK_WEBHOOK_URL;
                if (slackWebhookUrl) {
                    yield this.sendSlackAlert(slackWebhookUrl, event, eventCount, message);
                }
                // Generic webhook integration
                const webhookUrl = process.env.SECURITY_WEBHOOK_URL;
                if (webhookUrl) {
                    yield this.sendWebhookAlert(webhookUrl, event, eventCount, message);
                }
     ...
     * Send alert to Slack
     */
    sendSlackAlert(webhookUrl, event, eventCount, message) {
        return __awaiter(this, void 0, void 0, function* () {
            const slackPayload = {
     ...
     */
    sendWebhookAlert(webhookUrl, event, eventCount, message) {
        return __awaiter(this, void 0, void 0, function* () {
