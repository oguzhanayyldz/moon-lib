...
class RedisFailoverManager {
     ...
     */
    static async withRedisFailover(operation, fallback = null, config = {}) {
     ...
     */
    static async executeFallback(fallback, originalError) {
        if (fallback) {
            try {
    ...
    static startHealthCheck(config = {}) {
        ...
        this.healthCheckInterval = setInterval(async () => {
            try {
                ...
                await redisWrapper_service_1.redisWrapper.client.ping();
...
//# sourceMappingURL=redisFailoverManager.js.map