...
export interface OrderIntegrationProductCreted {
    ...
    commissionTotal?: number;
    // Komisyonun NEREDEN geldigi (issue #679). Pazaryeri API'si tutari veriyorsa
    // `Marketplace`; tutar gelmeyip orandan tahmin uretilmedigi icin baska deger
    // kullanilmaz. Faz 6'daki hakedis verisi ayni alani daha kesin kaynakla ezer.
