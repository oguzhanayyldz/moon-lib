 ...
 */
const extractPlatformFromIntegrationId = (integrationId, IntegrationModel) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const integration = yield IntegrationModel.findById(integrationId);
