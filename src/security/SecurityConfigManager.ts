...
export class SecurityConfigManager {
   ...
   */
  private loadConfiguration(): SecurityEnvironmentConfig {
    const config: SecurityEnvironmentConfig = {
      // File Upload Settings
      ...
      securityLogLevel: this.getEnvString('SECURITY_LOG_LEVEL', 'warn') as 'info' | 'warn' | 'error',
   ...
   */
  public getServiceConfig(serviceName: string): SecurityEnvironmentConfig {
   ...
   */
  public getConfiguration(): SecurityEnvironmentConfig {
    return { ...this.config };
  }
   ...
   */
  private validateConfiguration(config: SecurityEnvironmentConfig): void {
    const errors: string[] = [];
