...
class ChangeStreamManager extends BaseChangeStreamManager {
     ...
     */
    async startInventoryMonitoring(collectionName = 'productstocks') {
     ...
     * @deprecated Use service-specific change stream managers instead
     */
    async startOrderStatusMonitoring(collectionName = 'orders') {
     ...
     * @deprecated Use service-specific change stream managers instead
     */
    async startPriceMonitoring(collectionName = 'prices') {
...
//# sourceMappingURL=baseChangeStreamManager.service.js.map