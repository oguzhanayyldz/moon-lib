...
export const LINE_DISCOUNT_BASES: ReadonlyArray<LineDiscountBasis> = ['accounting', 'informational'];
export const ORDER_DISCOUNT_BASES: ReadonlyArray<OrderDiscountBasis> = ['in_lines', 'distribute', 'informational'];

export const AMOUNT_CONTRACT_VERSION = 2 as const;
