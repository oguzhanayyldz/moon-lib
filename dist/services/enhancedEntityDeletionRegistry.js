...
class EnhancedEntityDeletionRegistry {
    ...
    execute(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.ensureCacheWarmedUp();
                ...
                if (configWithDefaults.useTransactions && this.transactionManager) {
                    result = yield this.executeWithTransaction(enhancedContext);
                }
                else {
                    result = yield this.executeWithoutTransaction(enhancedContext);
                }
    ...
    executeBatch(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.batchProcessingEngine.processBatchDeletion(enhancedContext);
                const executionTime = timer.stop();
                // Record metrics
                if (result.success) {
    ...
    executeWithoutTransaction(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const validation = yield strategy.validate(context);
                if (!validation.isValid) {
                    return {
                        success: false,
                        deletedEntities: [],
                ...
                // Execute deletion
                const result = yield strategy.execute(context);
    ...
    warmUpCache() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield strategyCache_service_1.strategyCacheService.warmUp(this.strategies);
    ...
    shutdown() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.batchProcessingEngine.shutdown();
            // Clear all data
            this.clear();
