...
class ExcelParserService {
     ...
     */
    static async parseWorkbook(buffer, options = {}) {
     ...
     */
    static async validateStructure(buffer, requiredColumns) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
        const worksheet = workbook.worksheets[0];
        if (!worksheet) {
     ...
     */
    static async getSheetNames(buffer) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
     ...
     */
    static async parseSheetByName(buffer, sheetName, options = {}) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
     ...
     */
    static async parseSheetByIndex(buffer, sheetIndex, options = {}) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
     ...
     */
    static async parseAllSheets(buffer, options = {}) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
        const sheets = [];
     ...
     */
    static async parseSpecificSheets(buffer, sheetNames, options = {}) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
        const sheets = [];
     ...
     */
    static async validateMultiSheetStructure(buffer, validation) {
        const workbook = new ExcelJS.Workbook();
        await workbook.xlsx.load(buffer);
        const errors = [];
