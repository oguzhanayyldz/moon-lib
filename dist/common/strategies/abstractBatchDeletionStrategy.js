...
class AbstractBatchDeletionStrategy extends abstractDeletionStrategy_1.AbstractDeletionStrategy {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (canProcessInParallel && preparedItems.length > 1) {
                    result = yield this.processBatchInParallel(preparedItems, context, batchId);
                }
                else {
                    result = yield this.processBatchSequentially(preparedItems, context, batchId);
                }
    ...
    validateBatch(items, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customValidation = yield this.validateBatchCustom(items, context);
     ...
     */
    validateBatchCustom(items, context) {
        return __awaiter(this, void 0, void 0, function* () {
            return { errors: [] };
        });
    }
    ...
    estimateBatchComplexity(items) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customComplexity = yield this.calculateCustomComplexity(items);
     ...
     */
    calculateCustomComplexity(items) {
        return __awaiter(this, void 0, void 0, function* () {
            return 0;
        });
    }
     ...
     */
    processBatchSequentially(items, context, batchId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            for (const item of items) {
                try {
                    ...
                    const result = yield this.execute(deletionContext);
                    if (result.success) {
     ...
     */
    processBatchInParallel(items, context, batchId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            ...
            const results = yield Promise.allSettled(items.map(item => processItem(item)));
            const successfulItems = [];
            const failedItems = [];
            let databaseOperations = 0;
     ...
     */
    optimizeBatchProcessing(items, context) {
        return __awaiter(this, void 0, void 0, function* () {
            const complexity = yield this.estimateBatchComplexity(items);
     ...
     */
    handleBatchError(error_1, items_1, context_1) {
        return __awaiter(this, arguments, void 0, function* (error, items, context, retryCount = 0) {
            var _a;
            ...
            try {
                return yield this.processBatch(items, context);
            }
            catch (retryError) {
                return yield this.handleBatchError(retryError instanceof Error ? retryError : new Error('Unknown retry error'), items, context, retryCount + 1);
            }
        });
    }
    /**
