...
class AbstractDeletionStrategy {
     ...
     */
    async executeWithTracing(operationName, context, operation) {
        var _a;
     ...
     */
    async executeWithMetrics(context, operation) {
        var _a;
     ...
     * @returns Result of the operation
     */
    async executeWithErrorHandling(context, operation) {
        try {
            return await operation();
        }
        catch (error) {
...
//# sourceMappingURL=abstractDeletionStrategy.js.map